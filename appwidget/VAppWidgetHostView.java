 ...
 */
public class VAppWidgetHostView<T extends AppWidgetHostView> extends
		VaporAppWidgetHostView<T, VAppWidgetHostView<T>> {

	public VAppWidgetHostView(int id) {
		super(id);
	}

	public VAppWidgetHostView(T appWidgetHostView) {
