 ...
 * @param <X>
 *            A Vapor type derived from VViewGroup
 */
public abstract class VXViewGroup<T extends ViewGroup, X extends VaporViewGroup<T, ?>>
		extends VaporXViewGroup<T, X, VXViewGroup<T, X>> {

	public VXViewGroup(Integer... ids) {
		super(ids);
	}

	public VXViewGroup(T... viewGroups) {
		super(viewGroups);
	}

	public VXViewGroup(X... vaporViewGroups) {
		super(vaporViewGroups);
	}

	public VXViewGroup(VaporXViewGroup<T, X, ?>... vaporXViewGroups) {
		super(vaporXViewGroups);
	}

	public VXViewGroup(Object... viewGroupItems) {
