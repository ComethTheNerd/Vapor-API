 ...
 * @param <X>
 *            A Vapor type derived from VView
 */
public class VXView<T extends View, X extends VaporView<T, ?>> extends
		VaporXView<T, X, VXView<T, X>> {

	public VXView(Integer... ids) {
		super(ids);
	}

	public VXView(T... views) {
		super(views);
	}

	public VXView(X... vaporViews) {
		super(vaporViews);
	}

	public VXView(VaporXView<T, X, ?>... vaporXViews) {
		super(vaporXViews);
	}

	public VXView(Object... viewItems) {
		super(viewItems);
	}
