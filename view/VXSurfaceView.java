 ...
 * @param <X>
 *            A Vapor type derived from VSurfaceView
 */
public class VXSurfaceView<T extends SurfaceView, X extends VaporSurfaceView<T, ?>>
		extends VaporXSurfaceView<T, X, VXSurfaceView<T, X>> {

	public VXSurfaceView(Integer... ids) {
		super(ids);
	}

	public VXSurfaceView(T... surfaceViews) {
		super(surfaceViews);
	}

	public VXSurfaceView(X... vaporSurfaceViews) {
		super(vaporSurfaceViews);
	}

	public VXSurfaceView(VaporXSurfaceView<T, X, ?>... vaporXSurfaceViews) {
		super(vaporXSurfaceViews);
	}

	public VXSurfaceView(Object... surfaceViewItems) {
