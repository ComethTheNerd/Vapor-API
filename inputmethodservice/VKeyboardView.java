 ...
 */
public class VKeyboardView<T extends KeyboardView> extends
		VaporKeyboardView<T, VKeyboardView<T>> {

	public VKeyboardView(int id) {
		super(id);
	}

	public VKeyboardView(T keyboardView) {
		super(keyboardView);
	}
}