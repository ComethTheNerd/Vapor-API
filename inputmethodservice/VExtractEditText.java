 ...
 */
public class VExtractEditText<T extends ExtractEditText> extends
		VaporExtractEditText<T, VExtractEditText<T>> {

	public VExtractEditText(int id) {
		super(id);
	}

	public VExtractEditText(T extractEditText) {
