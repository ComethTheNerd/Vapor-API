 ...
 */
public class VGLSurfaceView<T extends GLSurfaceView> extends
		VaporGLSurfaceView<T, VGLSurfaceView<T>> {

	public VGLSurfaceView(int id) {
		super(id);
	}

	public VGLSurfaceView(T gLSurfaceView) {
		super(gLSurfaceView);
	}
}