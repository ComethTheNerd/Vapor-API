 ...
 */
public class VRelativeLayout<T extends RelativeLayout> extends
		VaporRelativeLayout<T, VRelativeLayout<T>> {

	public VRelativeLayout(int id) {
		super(id);
	}

	public VRelativeLayout(T relativeLayout) {
