 ...
 */
public class VCalendarView<T extends CalendarView> extends
		VaporCalendarView<T, VCalendarView<T>> {

	public VCalendarView(int id) {
		super(id);
	}

	public VCalendarView(T calendarView) {
		super(calendarView);
	}
}