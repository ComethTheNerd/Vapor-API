 ...
 */
public class VToggleButton<T extends ToggleButton> extends
		VaporToggleButton<T, VToggleButton<T>> {

	public VToggleButton(int id) {
		super(id);
	}

	public VToggleButton(T toggleButton) {
		super(toggleButton);
	}
}