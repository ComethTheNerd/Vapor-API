 ...
 */
public class VQuickContactBadge<T extends QuickContactBadge> extends
		VaporQuickContactBadge<T, VQuickContactBadge<T>> {

	public VQuickContactBadge(int id) {
		super(id);
	}

	public VQuickContactBadge(T quickContactBadge) {
