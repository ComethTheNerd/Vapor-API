 ...
 */
public class VCheckedTextView<T extends CheckedTextView> extends
		VaporCheckedTextView<T, VCheckedTextView<T>> {

	public VCheckedTextView(int id) {
		super(id);
	}

	public VCheckedTextView(T checkedTextView) {
