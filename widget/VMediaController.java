 ...
 */
public class VMediaController<T extends MediaController> extends
		VaporMediaController<T, VMediaController<T>> {

	public VMediaController(int id) {
		super(id);
	}

	public VMediaController(T mediaController) {
