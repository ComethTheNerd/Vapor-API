 ...
 */
public class VViewAnimator<T extends ViewAnimator> extends
		VaporViewAnimator<T, VViewAnimator<T>> {

	public VViewAnimator(int id) {
		super(id);
	}

	public VViewAnimator(T viewAnimator) {
		super(viewAnimator);
	}
}