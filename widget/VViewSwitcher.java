 ...
 */
public class VViewSwitcher<T extends ViewSwitcher> extends
		VaporViewSwitcher<T, VViewSwitcher<T>> {

	public VViewSwitcher(int id) {
		super(id);
	}

	public VViewSwitcher(T viewSwitcher) {
		super(viewSwitcher);
	}
}