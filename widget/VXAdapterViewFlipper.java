 ...
 * @param <X>
 *            A Vapor type derived from VAdapterViewFlipper
 */
public class VXAdapterViewFlipper<T extends AdapterViewFlipper, X extends VaporAdapterViewFlipper<T, ?>>
		extends VaporXAdapterViewFlipper<T, X, VXAdapterViewFlipper<T, X>> {

	public VXAdapterViewFlipper(Integer... ids) {
		super(ids);
	}

	public VXAdapterViewFlipper(T... adapterViewFlippers) {
		super(adapterViewFlippers);
	}

	public VXAdapterViewFlipper(X... vaporAdapterViewFlippers) {
		super(vaporAdapterViewFlippers);
	}

	public VXAdapterViewFlipper(
			VaporXAdapterViewFlipper<T, X, ?>... vaporXAdapterViewFlippers) {
		super(vaporXAdapterViewFlippers);
	}

	public VXAdapterViewFlipper(Object... adapterViewFlipperItems) {
