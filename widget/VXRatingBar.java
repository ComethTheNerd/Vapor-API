 ...
 * @param <X>
 *            A Vapor type derived from VRatingBar
 */
public class VXRatingBar<T extends RatingBar, X extends VaporRatingBar<T, ?>>
		extends VaporXRatingBar<T, X, VXRatingBar<T, X>> {

	public VXRatingBar(Integer... ids) {
		super(ids);
	}

	public VXRatingBar(T... ratingBars) {
		super(ratingBars);
	}

	public VXRatingBar(X... vaporRatingBars) {
		super(vaporRatingBars);
	}

	public VXRatingBar(VaporXRatingBar<T, X, ?>... vaporXRatingBars) {
		super(vaporXRatingBars);
	}

	public VXRatingBar(Object... ratingBarItems) {
