 ...
 * @param <X>
 *            A Vapor type derived from VLinearLayout
 */
public class VXLinearLayout<T extends LinearLayout, X extends VaporLinearLayout<T, ?>>
		extends VaporXLinearLayout<T, X, VXLinearLayout<T, X>> {

	public VXLinearLayout(Integer... ids) {
		super(ids);
	}

	public VXLinearLayout(T... linearLayouts) {
		super(linearLayouts);
	}

	public VXLinearLayout(X... vaporLinearLayouts) {
		super(vaporLinearLayouts);
	}

	public VXLinearLayout(VaporXLinearLayout<T, X, ?>... vaporXLinearLayouts) {
		super(vaporXLinearLayouts);
	}

	public VXLinearLayout(Object... linearLayoutItems) {
