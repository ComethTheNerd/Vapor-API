 ...
 * @param <X>
 *            A Vapor type derived from VImageView
 */
public class VXImageView<T extends ImageView, X extends VaporImageView<T, ?>>
		extends VaporXImageView<T, X, VXImageView<T, X>> {

	public VXImageView(Integer... ids) {
		super(ids);
	}

	public VXImageView(T... imageViews) {
		super(imageViews);
	}

	public VXImageView(X... vaporImageViews) {
		super(vaporImageViews);
	}

	public VXImageView(VaporXImageView<T, X, ?>... vaporXImageViews) {
		super(vaporXImageViews);
	}

	public VXImageView(Object... imageViewItems) {
