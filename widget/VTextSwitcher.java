 ...
 */
public class VTextSwitcher<T extends TextSwitcher> extends
		VaporTextSwitcher<T, VTextSwitcher<T>> {

	public VTextSwitcher(int id) {
		super(id);
	}

	public VTextSwitcher(T textSwitcher) {
		super(textSwitcher);
	}
}