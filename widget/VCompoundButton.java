 ...
 */
public abstract class VCompoundButton<T extends CompoundButton> extends
		VaporCompoundButton<T, VCompoundButton<T>> {

	public VCompoundButton(int id) {
		super(id);
	}

	public VCompoundButton(T compoundButton) {
