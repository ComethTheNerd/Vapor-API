 ...
 * @param <X>
 *            A Vapor type derived from VExpandableListView
 */
public class VXExpandableListView<T extends ExpandableListView, X extends VaporExpandableListView<T, ?>>
		extends VaporXExpandableListView<T, X, VXExpandableListView<T, X>> {

	public VXExpandableListView(Integer... ids) {
		super(ids);
	}

	public VXExpandableListView(T... expandableListViews) {
		super(expandableListViews);
	}

	public VXExpandableListView(X... vaporExpandableListViews) {
		super(vaporExpandableListViews);
	}

	public VXExpandableListView(
			VaporXExpandableListView<T, X, ?>... vaporXExpandableListViews) {
		super(vaporXExpandableListViews);
	}

	public VXExpandableListView(Object... expandableListViewItems) {
