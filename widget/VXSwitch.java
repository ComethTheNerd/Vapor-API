 ...
 * @param <X>
 *            A Vapor type derived from VSwitch
 */
public class VXSwitch<T extends Switch, X extends VaporSwitch<T, ?>> extends
		VaporXSwitch<T, X, VXSwitch<T, X>> {

	public VXSwitch(Integer... ids) {
		super(ids);
	}

	public VXSwitch(T... switchs) {
		super(switchs);
	}

	public VXSwitch(X... vaporSwitchs) {
		super(vaporSwitchs);
	}

	public VXSwitch(VaporXSwitch<T, X, ?>... vaporXSwitchs) {
		super(vaporXSwitchs);
	}

	public VXSwitch(Object... switchItems) {
		super(switchItems);
	}
