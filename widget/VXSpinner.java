 ...
 * @param <X>
 *            A Vapor type derived from VSpinner
 */
public class VXSpinner<T extends Spinner, X extends VaporSpinner<T, ?>> extends
		VaporXSpinner<T, X, VXSpinner<T, X>> {

	public VXSpinner(Integer... ids) {
		super(ids);
	}

	public VXSpinner(T... spinners) {
		super(spinners);
	}

	public VXSpinner(X... vaporSpinners) {
		super(vaporSpinners);
	}

	public VXSpinner(VaporXSpinner<T, X, ?>... vaporXSpinners) {
		super(vaporXSpinners);
	}

	public VXSpinner(Object... spinnerItems) {
		super(spinnerItems);
	}
