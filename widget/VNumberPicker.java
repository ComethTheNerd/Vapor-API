 ...
 */
public class VNumberPicker<T extends NumberPicker> extends
		VaporNumberPicker<T, VNumberPicker<T>> {

	public VNumberPicker(int id) {
		super(id);
	}

	public VNumberPicker(T numberPicker) {
		super(numberPicker);
	}
}