 ...
 */
public class VHorizontalScrollView<T extends HorizontalScrollView> extends
		VaporHorizontalScrollView<T, VHorizontalScrollView<T>> {

	public VHorizontalScrollView(int id) {
		super(id);
	}

	public VHorizontalScrollView(T horizontalScrollView) {
