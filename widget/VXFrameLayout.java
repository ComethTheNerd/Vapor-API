 ...
 * @param <X>
 *            A Vapor type derived from VFrameLayout
 */
public class VXFrameLayout<T extends FrameLayout, X extends VaporFrameLayout<T, ?>>
		extends VaporXFrameLayout<T, X, VXFrameLayout<T, X>> {

	public VXFrameLayout(Integer... ids) {
		super(ids);
	}

	public VXFrameLayout(T... frameLayouts) {
		super(frameLayouts);
	}

	public VXFrameLayout(X... vaporFrameLayouts) {
		super(vaporFrameLayouts);
	}

	public VXFrameLayout(VaporXFrameLayout<T, X, ?>... vaporXFrameLayouts) {
		super(vaporXFrameLayouts);
	}

	public VXFrameLayout(Object... frameLayoutItems) {
