 ...
 * @param <X>
 *            A Vapor type derived from VHorizontalScrollView
 */
public class VXHorizontalScrollView<T extends HorizontalScrollView, X extends VaporHorizontalScrollView<T, ?>>
		extends VaporXHorizontalScrollView<T, X, VXHorizontalScrollView<T, X>> {

	public VXHorizontalScrollView(Integer... ids) {
		super(ids);
	}

	public VXHorizontalScrollView(T... horizontalScrollViews) {
		super(horizontalScrollViews);
	}

	public VXHorizontalScrollView(X... vaporHorizontalScrollViews) {
		super(vaporHorizontalScrollViews);
	}

	public VXHorizontalScrollView(
			VaporXHorizontalScrollView<T, X, ?>... vaporXHorizontalScrollViews) {
		super(vaporXHorizontalScrollViews);
	}

	public VXHorizontalScrollView(Object... horizontalScrollViewItems) {
