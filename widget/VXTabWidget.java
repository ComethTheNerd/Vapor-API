 ...
 * @param <X>
 *            A Vapor type derived from VTabWidget
 */
public class VXTabWidget<T extends TabWidget, X extends VaporTabWidget<T, ?>>
		extends VaporXTabWidget<T, X, VXTabWidget<T, X>> {

	public VXTabWidget(Integer... ids) {
		super(ids);
	}

	public VXTabWidget(T... tabWidgets) {
		super(tabWidgets);
	}

	public VXTabWidget(X... vaporTabWidgets) {
		super(vaporTabWidgets);
	}

	public VXTabWidget(VaporXTabWidget<T, X, ?>... vaporXTabWidgets) {
		super(vaporXTabWidgets);
	}

	public VXTabWidget(Object... tabWidgetItems) {
