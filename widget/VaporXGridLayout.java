...
/**
 * Fluent variadic Vapor companion to GridLayout, a layout that places its
 * children in a rectangular grid. The grid is composed of a set of infinitely
 * thin lines that separate the viewing area into cells.
 * 
 ...
 * @param <X>
 *            A Vapor type derived from VaporGridLayout
 * @param <self>
 *            A recursively defined type that provides information for fluent
 *            method invocation
 */
public class VaporXGridLayout<T extends GridLayout, X extends VaporGridLayout<T, ?>, self extends VaporXGridLayout<T, X, self>>
		extends VaporXViewGroup<T, X, self> {

	public VaporXGridLayout(Integer... ids) {
		super(ids);
	}

	public VaporXGridLayout(T... gridLayouts) {
		super(gridLayouts);
	}

	public VaporXGridLayout(X... vaporGridLayouts) {
		super(vaporGridLayouts);
	}

	public VaporXGridLayout(VaporXGridLayout<T, X, ?>... vaporXGridLayouts) {
		super(vaporXGridLayouts);
	}

	public VaporXGridLayout(Object... gridLayoutItems) {
		super(gridLayoutItems);
	}
	...
	public self alignMode(int alignmentMode) {
		for (X vaporView : members)
			vaporView.alignMode(alignmentMode);
		return (self) this;
	 ...
	 */
	public ArrayList<Boolean> defMargins() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).defMargins());
		return _returns;
	}
	...
	public self defMargins(boolean useDefaultMargins) {
		for (X vaporView : members)
			vaporView.defMargins(useDefaultMargins);
		return (self) this;
	 ...
	 */
	public ArrayList<Boolean> keepColOrder() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).keepColOrder());
		return _returns;
	}
	...
	public self keepColOrder(boolean columnOrderPreserved) {
		for (X vaporView : members)
			vaporView.keepColOrder(columnOrderPreserved);
		return (self) this;
	 ...
	 *         false otherwise
	 */
	public ArrayList<Boolean> keepRowOrder() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).keepRowOrder());
		return _returns;
	}
	...
	public self keepRowOrder(boolean rowOrderPreserved) {
		for (X vaporView : members)
			vaporView.keepRowOrder(rowOrderPreserved);
		return (self) this;
	...
	public ArrayList<Integer> rows() {
		...
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).rows());
		return _returns;
	}
