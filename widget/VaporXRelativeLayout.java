...
/**
 * Fluent variadic Vapor companion to RelativeLayout, a Layout where the
 * positions of the children can be described in relation to each other or to
 * the parent.
 * 
 ...
 * @param <X>
 *            A Vapor type derived from VaporRelativeLayout
 * @param <self>
 *            A recursively defined type that provides information for fluent
 *            method invocation
 */
public class VaporXRelativeLayout<T extends RelativeLayout, X extends VaporRelativeLayout<T, ?>, self extends VaporXRelativeLayout<T, X, self>>
		extends VaporXViewGroup<T, X, self> {

	public VaporXRelativeLayout(Integer... ids) {
		super(ids);
	}

	public VaporXRelativeLayout(T... relativeLayouts) {
		super(relativeLayouts);
	}

	public VaporXRelativeLayout(X... vaporRelativeLayouts) {
		super(vaporRelativeLayouts);
	}

	public VaporXRelativeLayout(
			VaporXRelativeLayout<T, X, ?>... vaporXRelativeLayouts) {
		super(vaporXRelativeLayouts);
	}

	public VaporXRelativeLayout(Object... relativeLayoutItems) {
		super(relativeLayoutItems);
	}
	...
	public self ignoreGravity(int viewId) {
		for (X vaporView : members)
			vaporView.ignoreGravity(viewId);
		return (self) this;
