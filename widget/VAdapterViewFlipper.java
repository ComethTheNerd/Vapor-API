 ...
 */
public class VAdapterViewFlipper<T extends AdapterViewFlipper> extends
		VaporAdapterViewFlipper<T, VAdapterViewFlipper<T>> {

	public VAdapterViewFlipper(int id) {
		super(id);
	}

	public VAdapterViewFlipper(T adapterViewFlipper) {
