 ...
 * @param <X>
 *            A Vapor type derived from VChronometer
 */
public class VXChronometer<T extends Chronometer, X extends VaporChronometer<T, ?>>
		extends VaporXChronometer<T, X, VXChronometer<T, X>> {

	public VXChronometer(Integer... ids) {
		super(ids);
	}

	public VXChronometer(T... chronometers) {
		super(chronometers);
	}

	public VXChronometer(X... vaporChronometers) {
		super(vaporChronometers);
	}

	public VXChronometer(VaporXChronometer<T, X, ?>... vaporXChronometers) {
		super(vaporXChronometers);
	}

	public VXChronometer(Object... chronometerItems) {
