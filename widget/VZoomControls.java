 ...
 */
public class VZoomControls<T extends ZoomControls> extends
		VaporZoomControls<T, VZoomControls<T>> {

	public VZoomControls(int id) {
		super(id);
	}

	public VZoomControls(T zoomControls) {
		super(zoomControls);
	}
}