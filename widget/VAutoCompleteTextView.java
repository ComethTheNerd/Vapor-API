 ...
 */
public class VAutoCompleteTextView<T extends AutoCompleteTextView> extends
		VaporAutoCompleteTextView<T, VAutoCompleteTextView<T>> {

	public VAutoCompleteTextView(int id) {
		super(id);
	}

	public VAutoCompleteTextView(T autoCompleteTextView) {
