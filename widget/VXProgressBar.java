 ...
 * @param <X>
 *            A Vapor type derived from VProgressBar
 */
public class VXProgressBar<T extends ProgressBar, X extends VaporProgressBar<T, ?>>
		extends VaporXProgressBar<T, X, VXProgressBar<T, X>> {

	public VXProgressBar(Integer... ids) {
		super(ids);
	}

	public VXProgressBar(T... progressBars) {
		super(progressBars);
	}

	public VXProgressBar(X... vaporProgressBars) {
		super(vaporProgressBars);
	}

	public VXProgressBar(VaporXProgressBar<T, X, ?>... vaporXProgressBars) {
		super(vaporXProgressBars);
	}

	public VXProgressBar(Object... progressBarItems) {
