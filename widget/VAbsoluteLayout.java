 ...
 */
public class VAbsoluteLayout<T extends AbsoluteLayout> extends
		VaporAbsoluteLayout<T, VAbsoluteLayout<T>> {

	public VAbsoluteLayout(int id) {
		super(id);
	}

	public VAbsoluteLayout(T absoluteLayout) {
