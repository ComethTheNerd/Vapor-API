 ...
 * @param <X>
 *            A Vapor type derived from VAbsListView
 */
public abstract class VXAbsListView<T extends AbsListView, X extends VaporAbsListView<T, ?>>
		extends VaporXAbsListView<T, X, VXAbsListView<T, X>> {

	public VXAbsListView(Integer... ids) {
		super(ids);
	}

	public VXAbsListView(T... absListViews) {
		super(absListViews);
	}

	public VXAbsListView(X... vaporAbsListViews) {
		super(vaporAbsListViews);
	}

	public VXAbsListView(VaporXAbsListView<T, X, ?>... vaporXAbsListViews) {
		super(vaporXAbsListViews);
	}

	public VXAbsListView(Object... absListViewItems) {
