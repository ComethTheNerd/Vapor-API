 ...
 */
public class VExpandableListView<T extends ExpandableListView> extends
		VaporExpandableListView<T, VExpandableListView<T>> {

	public VExpandableListView(int id) {
		super(id);
	}

	public VExpandableListView(T expandableListView) {
