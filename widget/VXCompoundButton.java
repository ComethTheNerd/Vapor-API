 ...
 * @param <X>
 *            A Vapor type derived from VCompoundButton
 */
public abstract class VXCompoundButton<T extends CompoundButton, X extends VaporCompoundButton<T, ?>>
		extends VaporXCompoundButton<T, X, VXCompoundButton<T, X>> {

	public VXCompoundButton(Integer... ids) {
		super(ids);
	}

	public VXCompoundButton(T... compoundButtons) {
		super(compoundButtons);
	}

	public VXCompoundButton(X... vaporCompoundButtons) {
		super(vaporCompoundButtons);
	}

	public VXCompoundButton(
			VaporXCompoundButton<T, X, ?>... vaporXCompoundButtons) {
		super(vaporXCompoundButtons);
	}

	public VXCompoundButton(Object... compoundButtonItems) {
