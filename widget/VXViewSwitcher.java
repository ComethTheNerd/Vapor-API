 ...
 * @param <X>
 *            A Vapor type derived from VViewSwitcher
 */
public class VXViewSwitcher<T extends ViewSwitcher, X extends VaporViewSwitcher<T, ?>>
		extends VaporXViewSwitcher<T, X, VXViewSwitcher<T, X>> {

	public VXViewSwitcher(Integer... ids) {
		super(ids);
	}

	public VXViewSwitcher(T... viewSwitchers) {
		super(viewSwitchers);
	}

	public VXViewSwitcher(X... vaporViewSwitchers) {
		super(vaporViewSwitchers);
	}

	public VXViewSwitcher(VaporXViewSwitcher<T, X, ?>... vaporXViewSwitchers) {
		super(vaporXViewSwitchers);
	}

	public VXViewSwitcher(Object... viewSwitcherItems) {
