 ...
 */
public abstract class VAdapterViewAnimator<T extends AdapterViewAnimator>
		extends VaporAdapterViewAnimator<T, VAdapterViewAnimator<T>> {

	public VAdapterViewAnimator(int id) {
		super(id);
	}

	public VAdapterViewAnimator(T adapterViewAnimator) {
