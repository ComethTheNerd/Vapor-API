...
/**
 * Fluent variadic Vapor companion to TextView, which displays text to the user
 * and optionally allows them to edit it. A TextView is a complete text editor,
 ...
 * @param <X>
 *            A Vapor type derived from VaporTextView
 * @param <self>
 *            A recursively defined type that provides information for fluent
 *            method invocation
 */
public class VaporXTextView<T extends TextView, X extends VaporTextView<T, ?>, self extends VaporXTextView<T, X, self>>
		extends VaporXView<T, X, self> {

	public VaporXTextView(Integer... ids) {
		super(ids);
	}

	public VaporXTextView(T... textViews) {
		super(textViews);
	}

	public VaporXTextView(X... vaporTextViews) {
		super(vaporTextViews);
	}

	public VaporXTextView(VaporXTextView<T, X, ?>... vaporXTextViews) {
		super(vaporXTextViews);
	}

	public VaporXTextView(Object... textViewItems) {
		super(textViewItems);
	}
	...
	public self append(CharSequence text, int start, int end) {
		for (X vaporView : members)
			vaporView.append(text, start, end);
		return (self) this;
	 ...
	 * @return
	 */
	public ArrayList<Boolean> bringPoint(int offset) {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).bringPoint(offset));
		return _returns;
	}
	 ...
	 * @return
	 */
	public final ArrayList<Boolean> clickableLinks() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).clickableLinks());
		return _returns;
	}
	...
	public final self clickableLinks(boolean clickableLinks) {
		for (X vaporView : members)
			vaporView.clickableLinks(clickableLinks);
		return (self) this;
	}
	 ...
	 * @return
	 */
	public final ArrayList<ColorStateList> colors() {
		int _size = this.members.size();
		ArrayList<ColorStateList> _returns = new ArrayList<ColorStateList>(
				_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).colors());
		return _returns;
	}
	...
	public self commitCompletion(CompletionInfo completionInfo) {
		for (X vaporView : members)
			vaporView.commitCompletion(completionInfo);
		return (self) this;
	...
	public self commitCorrection(CorrectionInfo correctionInfo) {
		for (X vaporView : members)
			vaporView.commitCorrection(correctionInfo);
		return (self) this;
	 ...
	 */
	public ArrayList<Drawable[]> compoundImgs() {
		int _size = this.members.size();
		ArrayList<Drawable[]> _returns = new ArrayList<Drawable[]>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).compoundImgs());
		return _returns;
	}
	...
	public self compoundImgs(Drawable left, Drawable top, Drawable right,
			Drawable bottom) {
		for (X vaporView : members)
			vaporView.compoundImgs(left, top, right, bottom);
		return (self) this;
	...
	public self intrinsicCompoundImgs(Drawable left, Drawable top,
		...
		for (X vaporView : members)
			vaporView.intrinsicCompoundImgs(left, top, right, bottom);
		return (self) this;
	 ...
	 */
	public ArrayList<Integer> compoundPad() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).compoundPad());
		return _returns;
	}
	 ...
	 *         Drawable if any.
	 */
	public ArrayList<Integer> compoundPadBottom() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).compoundPadBottom());
		return _returns;
	}
	 ...
	 *         any.
	 */
	public ArrayList<Integer> compoundPadLeft() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).compoundPadLeft());
		return _returns;
	}
	 ...
	 *         if any.
	 */
	public ArrayList<Integer> compoundPadRight() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).compoundPadRight());
		return _returns;
	}
	 ...
	 *         any.
	 */
	public ArrayList<Integer> compoundPadTop() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).compoundPadTop());
		return _returns;
	}
	 ...
	 *         editable)
	 */
	public ArrayList<Boolean> cursorViz() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).cursorViz());
		return _returns;
	}
	...
	public self cursorViz(boolean cursorVisible) {
		for (X vaporView : members)
			vaporView.cursorViz(cursorVisible);
		return (self) this;
	 ...
	 */
	public final ArrayList<Integer> currentColor() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).currentColor());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Editable> editableText() {
		int _size = this.members.size();
		ArrayList<Editable> _returns = new ArrayList<Editable>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).editableText());
		return _returns;
	}
	...
	public self edit(vapor.listeners.widget.textview.$edit editorActionListener) {
		for (X vaporView : members)
			vaporView.edit(editorActionListener);
		return (self) this;
	...
	public self editAction(int actionCode) {
		for (X vaporView : members)
			vaporView.editAction(actionCode);
		return (self) this;
	...
	public final self editFactory(Editable.Factory editableFactory) {
		for (X vaporView : members)
			vaporView.editFactory(editableFactory);
		return (self) this;
	}
	 ...
	 */
	public ArrayList<CharSequence> error() {
		int _size = this.members.size();
		ArrayList<CharSequence> _returns = new ArrayList<CharSequence>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).error());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Boolean> extract(ExtractedTextRequest request,
			ExtractedText outText) {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).extract(request, outText));
		return _returns;
	}
	...
	public self extract(ExtractedText extractedText) {
		for (X vaporView : members)
			vaporView.extract(extractedText);
		return (self) this;
	 ...
	 * @return
	 */
	public ArrayList<VaporBundle> extras(boolean create) {
		int _size = this.members.size();
		ArrayList<VaporBundle> _returns = new ArrayList<VaporBundle>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).extras(create));
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> padBottomExt() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).padBottomExt());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> padTopExt() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).padTopExt());
		return _returns;
	}
	...
	public ArrayList<InputFilter[]> filters() {
		int _size = this.members.size();
		ArrayList<InputFilter[]> _returns = new ArrayList<InputFilter[]>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).filters());
		return _returns;
	}
	...
	public self focusSelectAll(boolean selectAllOnFocus) {
		for (X vaporView : members)
			vaporView.focusSelectAll(selectAllOnFocus);
		return (self) this;
	 ...
	 *         displayed.
	 */
	public ArrayList<Typeface> font() {
		int _size = this.members.size();
		ArrayList<Typeface> _returns = new ArrayList<Typeface>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).font());
		return _returns;
	}
	 ...
	 * @return
	 */
	public ArrayList<Boolean> fontPadding() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).fontPadding());
		return _returns;
	}
	...
	public self fontPadding(boolean includePadding) {
		for (X vaporView : members)
			vaporView.fontPadding(includePadding);
		return (self) this;
	 ...
	 */
	public ArrayList<Float> fontSize() {
		int _size = this.members.size();
		ArrayList<Float> _returns = new ArrayList<Float>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).fontSize());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Boolean> freezes() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).freezes());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> hiColor() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).hiColor());
		return _returns;
	}
	 ...
	 */
	public final ArrayList<Integer> hintColor() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).hintColor());
		return _returns;
	}
	 ...
	 *         TextView.
	 */
	public final ArrayList<ColorStateList> hintColors() {
		int _size = this.members.size();
		ArrayList<ColorStateList> _returns = new ArrayList<ColorStateList>(
				_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).hintColors());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> imeId() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).imeId());
		return _returns;
	}
	 ...
	 *         int).
	 */
	public ArrayList<CharSequence> imeLabel() {
		int _size = this.members.size();
		ArrayList<CharSequence> _returns = new ArrayList<CharSequence>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).imeLabel());
		return _returns;
	}
	...
	public self imeLabel(CharSequence label, int actionId) {
		for (X vaporView : members)
			vaporView.imeLabel(label, actionId);
		return (self) this;
	 ...
	 */
	public ArrayList<String> privateIme() {
		int _size = this.members.size();
		ArrayList<String> _returns = new ArrayList<String>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).privateIme());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Boolean> privateImeCommand(String action, VaporBundle data) {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).privateImeCommand(action,
					data));
		return _returns;
	}
	 ...
	 * @return
	 */
	public ArrayList<Boolean> inputTarget() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).inputTarget());
		return _returns;
	}
	 ...
	 */
	public final ArrayList<KeyListener> keyListener() {
		int _size = this.members.size();
		ArrayList<KeyListener> _returns = new ArrayList<KeyListener>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).keyListener());
		return _returns;
	}
	 ...
	 *         can be null if the text or width has recently changes.
	 */
	public final ArrayList<Layout> layout() {
		int _size = this.members.size();
		ArrayList<Layout> _returns = new ArrayList<Layout>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).layout());
		return _returns;
	}
	...
	public ArrayList<Integer> length() {
		...
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).length());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> lineBounds(int line) {
	 ...
	 * @return the Y-coordinate of the baseline
	 */
	public ArrayList<Integer> lineBounds(int line, Rect bounds) {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).lineBounds(line, bounds));
		return _returns;
	}
	...
	public ArrayList<Integer> lines() {
		...
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).lines());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> lineHeight() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).lineHeight());
		return _returns;
	}
	 ...
	 *         TextView.
	 */
	public ArrayList<Float> lineSpaceExtra() {
		int _size = this.members.size();
		ArrayList<Float> _returns = new ArrayList<Float>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).lineSpaceExtra());
		return _returns;
	}
	 ...
	 *         actual height.
	 */
	public ArrayList<Float> lineSpaceMultiplier() {
		int _size = this.members.size();
		ArrayList<Float> _returns = new ArrayList<Float>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).lineSpaceMultiplier());
		return _returns;
	}
	 ...
	 *         different states of this TextView
	 */
	public ArrayList<ColorStateList> linkColors() {
		int _size = this.members.size();
		ArrayList<ColorStateList> _returns = new ArrayList<ColorStateList>(
				_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).linkColors());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> marqueeRepeatLimit() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).marqueeRepeatLimit());
		return _returns;
	}
	...
	public self marqueeRepeatLimit(int marqueeLimit) {
		for (X vaporView : members)
			vaporView.marqueeRepeatLimit(marqueeLimit);
		return (self) this;
	 ...
	 */
	public final ArrayList<Integer> mask() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).mask());
		return _returns;
	}
	 ...
	 *         width(int)).
	 */
	public ArrayList<Integer> maxEms() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).maxEms());
		return _returns;
	}
	 ...
	 *         height(int).
	 */
	public ArrayList<Integer> maxLines() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).maxLines());
		return _returns;
	}
	 ...
	 *         width(int)).
	 */
	public ArrayList<Integer> minEms() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).minEms());
		return _returns;
	}
	 ...
	 *         height(int).
	 */
	public ArrayList<Integer> minLines() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).minLines());
		return _returns;
	}
	 ...
	 */
	public final ArrayList<MovementMethod> moveMethod() {
		int _size = this.members.size();
		ArrayList<MovementMethod> _returns = new ArrayList<MovementMethod>(
				_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).moveMethod());
		return _returns;
	}
	...
	public final self moveMethod(MovementMethod movementMethod) {
		for (X vaporView : members)
			vaporView.moveMethod(movementMethod);
		return (self) this;
	}
	 ...
	 */
	public ArrayList<Boolean> offsetCursor() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).offsetCursor());
		return _returns;
	}
	 ...
	 */
	public ArrayList<TextPaint> paint() {
		int _size = this.members.size();
		ArrayList<TextPaint> _returns = new ArrayList<TextPaint>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).paint());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> paintFlags() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).paintFlags());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> offsetPos(float x, float y) {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).offsetPos(x, y));
		return _returns;
	}
	 ...
	 *         cancel.
	 */
	public ArrayList<Boolean> preDraw() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).preDraw());
		return _returns;
	}
	...
	public self rawInputType(int rawInputType) {
		for (X vaporView : members)
			vaporView.rawInputType(rawInputType);
		return (self) this;
	 ...
	 *         the user.
	 */
	public ArrayList<Boolean> selectableText() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).selectableText());
		return _returns;
	}
	...
	public self selectableText(boolean textIsSelectable) {
		for (X vaporView : members)
			vaporView.selectableText(textIsSelectable);
		return (self) this;
	...
	public ArrayList<Boolean> selection() {
		...
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).selection());
		return _returns;
	}
	...
	public self selection(ActionMode.Callback actionModeCallback) {
		for (X vaporView : members)
			vaporView.selection(actionModeCallback);
		return (self) this;
	 ...
	 * @return
	 */
	public ArrayList<Integer> selectionEnd() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).selectionEnd());
		return _returns;
	}
	 ...
	 * @return
	 */
	public ArrayList<Integer> selectionStart() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).selectionStart());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Integer> shadowColor() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).shadowColor());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Float> shadowDx() {
		int _size = this.members.size();
		ArrayList<Float> _returns = new ArrayList<Float>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).shadowDx());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Float> shadowDy() {
		int _size = this.members.size();
		ArrayList<Float> _returns = new ArrayList<Float>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).shadowDy());
		return _returns;
	}
	...
	public self shadowLayer(float radius, float dx, float dy, int color) {
		for (X vaporView : members)
			vaporView.shadowLayer(radius, dx, dy, color);
		return (self) this;
	 ...
	 *         visible
	 */
	public ArrayList<Float> shadowRadius() {
		int _size = this.members.size();
		ArrayList<Float> _returns = new ArrayList<Float>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).shadowRadius());
		return _returns;
	}
	...
	public self singleLine(boolean singleLine) {
		for (X vaporView : members)
			vaporView.singleLine(singleLine);
		return (self) this;
	...
	public final self spanFactory(Spannable.Factory spannableFactory) {
		for (X vaporView : members)
			vaporView.spanFactory(spannableFactory);
		return (self) this;
	}
	...
	public final self statefulText(CharSequence text,
		...
		for (X vaporView : members)
			vaporView.statefulText(text, bufferType);
	 ...
	 *         inputType.
	 */
	public ArrayList<Boolean> suggests() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).suggests());
		return _returns;
	}
	...
	public ArrayList<CharSequence> text() {
		...
		ArrayList<CharSequence> _returns = new ArrayList<CharSequence>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).text());
		return _returns;
	}
	...
	public final self text(CharSequence text, TextView.BufferType bufferType) {
		for (X vaporView : members)
			vaporView.text(text, bufferType);
		return (self) this;
	}
	...
	public final self text(char[] text, int start, int length) {
		for (X vaporView : members)
			vaporView.text(text, start, length);
		return (self) this;
	}
	...
	public final self text(int resId, TextView.BufferType bufferType) {
		for (X vaporView : members)
			vaporView.text(resId, bufferType);
		return (self) this;
	}
	 ...
	 */
	public ArrayList<Boolean> textOption(int id) {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).textOption(id));
		return _returns;
	}
	 ...
	 */
	public ArrayList<Float> textScaleX() {
		int _size = this.members.size();
		ArrayList<Float> _returns = new ArrayList<Float>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).textScaleX());
		return _returns;
	}
	 ...
	 * @return
	 */
	public ArrayList<Integer> totalPadBottom() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).totalPadBottom());
		return _returns;
	}
	 ...
	 * @return
	 */
	public ArrayList<Integer> totalPadLeft() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).totalPadLeft());
		return _returns;
	}
	 ...
	 * @return
	 */
	public ArrayList<Integer> totalPadRight() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).totalPadRight());
		return _returns;
	}
	 ...
	 * @return
	 */
	public ArrayList<Integer> totalPadTop() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).totalPadTop());
		return _returns;
	}
	 ...
	 */
	public ArrayList<Boolean> touchFocused() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).touchFocused());
		return _returns;
	}
	 ...
	 */
	public final ArrayList<TransformationMethod> transformMethod() {
		int _size = this.members.size();
		ArrayList<TransformationMethod> _returns = new ArrayList<TransformationMethod>(
				_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).transformMethod());
		return _returns;
	}
	...
	public final self transformMethod(TransformationMethod transformationMethod) {
		for (X vaporView : members)
			vaporView.transformMethod(transformationMethod);
		return (self) this;
	}
	 ...
	 * @return
	 */
	public ArrayList<URLSpan[]> urls() {
		int _size = this.members.size();
		ArrayList<URLSpan[]> _returns = new ArrayList<URLSpan[]>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).urls());
		return _returns;
	}
