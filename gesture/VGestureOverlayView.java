 ...
 */
public class VGestureOverlayView<T extends GestureOverlayView> extends
		VaporGestureOverlayView<T, VGestureOverlayView<T>> {

	public VGestureOverlayView(int id) {
		super(id);
	}

	public VGestureOverlayView(T gestureOverlayView) {
