 ...
 */
public class VFragmentTabHost<T extends FragmentTabHost> extends
VaporFragmentTabHost<T, VFragmentTabHost<T>>{

	public VFragmentTabHost(int id) {
		super(id);
	}

	public VFragmentTabHost(T fragmentTabHost) {
