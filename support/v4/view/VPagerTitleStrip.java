 ...
 */
public class VPagerTitleStrip<T extends PagerTitleStrip> extends
		VaporPagerTitleStrip<T, VPagerTitleStrip<T>> {

	public VPagerTitleStrip(int id) {
		super(id);
	}

	public VPagerTitleStrip(T pagerTitleStrip) {
