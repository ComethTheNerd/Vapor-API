 ...
 */
public class VPagerTabStrip<T extends PagerTabStrip> extends
		VaporPagerTabStrip<T, VPagerTabStrip<T>> {

	public VPagerTabStrip(int id) {
		super(id);
	}

	public VPagerTabStrip(T pagerTabStrip) {
		super(pagerTabStrip);
	}
}