...
/**
 * Fluent variadic Vapor companion to PagerTitleStrip, a non-interactive
 * indicator of the current, next, and previous pages of a ViewPager.
 * 
 ...
 * @param <X>
 *            A Vapor type derived from VaporPagerTitleStrip
 * @param <self>
 *            A recursively defined type that provides information for fluent
 *            method invocation
 */
public class VaporXPagerTitleStrip<T extends PagerTitleStrip, X extends VaporPagerTitleStrip<T, ?>, self extends VaporXPagerTitleStrip<T, X, self>>
		extends VaporXViewGroup<T, X, self> {

	public VaporXPagerTitleStrip(Integer... ids) {
		super(ids);
	}

	public VaporXPagerTitleStrip(T... pagerTitleStrips) {
		super(pagerTitleStrips);
	}

	public VaporXPagerTitleStrip(X... vaporPagerTitleStrips) {
		super(vaporPagerTitleStrips);
	}

	public VaporXPagerTitleStrip(
			VaporXPagerTitleStrip<T, X, ?>... vaporXPagerTitleStrips) {
		super(vaporXPagerTitleStrips);
	}

	public VaporXPagerTitleStrip(Object... pagerTitleStripItems) {
		super(pagerTitleStripItems);
	}
	...
	public self alphaNonPrim(float nonPrimaryAlpha) {
		for (X vaporView : members)
			vaporView.alphaNonPrim(nonPrimaryAlpha);
		return (self) this;
	...
	public self fontSize(int unit, float textSize) {
		for (X vaporView : members)
			vaporView.fontSize(unit, textSize);
		return (self) this;
	...
	public ArrayList<Integer> spacing() {
		...
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).spacing());
		return _returns;
	}
