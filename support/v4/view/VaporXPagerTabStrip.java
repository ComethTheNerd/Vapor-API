 ...
 * @param <X>
 *            A Vapor type derived from VaporPagerTabStrip
 * @param <self>
 *            A recursively defined type that provides information for fluent
 *            method invocation
 */
public class VaporXPagerTabStrip<T extends PagerTabStrip, X extends VaporPagerTabStrip<T, ?>, self extends VaporXPagerTabStrip<T, X, self>>
		extends VaporXPagerTitleStrip<T, X, self> {

	public VaporXPagerTabStrip(Integer... ids) {
		super(ids);
	}

	public VaporXPagerTabStrip(T... pagerTabStrips) {
		super(pagerTabStrips);
	}

	public VaporXPagerTabStrip(X... vaporPagerTabStrips) {
		super(vaporPagerTabStrips);
	}

	public VaporXPagerTabStrip(
			VaporXPagerTabStrip<T, X, ?>... vaporXPagerTabStrips) {
		super(vaporXPagerTabStrips);
	}

	public VaporXPagerTabStrip(Object... pagerTabStripItems) {
	 ...
	 */
	public ArrayList<Integer> indicatorColor() {
		int _size = this.members.size();
		ArrayList<Integer> _returns = new ArrayList<Integer>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).indicatorColor());
		return _returns;
	}
	...
	public self indicatorColor(int indicatorColor) {
		for (X vaporView : members)
			vaporView.indicatorColor(indicatorColor);
		return (self) this;
	...
	public self indicatorColorRes(int resId) {
		for (X vaporView : members)
			vaporView.indicatorColorRes(resId);
		return (self) this;
	 ...
	 */
	public ArrayList<Boolean> underlined() {
		int _size = this.members.size();
		ArrayList<Boolean> _returns = new ArrayList<Boolean>(_size);
		for (int _index = 0; _index < _size; _index++)
			_returns.add(this.members.get(_index).underlined());
		return _returns;
	}
	...
	public self underlined(boolean drawFullUnderline) {
		for (X vaporView : members)
			vaporView.underlined(drawFullUnderline);
		return (self) this;
